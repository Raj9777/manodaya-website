...
export const SafeSpaceIllustration = () => (
  <svg viewBox="0 0 500 400" className="section-svg-graphic" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M250 110 C180 30 80 85 80 185 C80 285 250 365 250 365 C250 365 420 285 420 185 C420 85 320 30 250 110 Z" fill="#FFA6DF" />
...
export const LiveVideoToolkitIllustration = () => (
  <svg viewBox="0 0 320 240" className="section-svg-graphic" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M160 90 C155 85 150 88 150 93 C150 98 160 104 160 104 C160 104 170 98 170 93 C170 88 165 85 160 90 Z" fill="#FF497C" />
    <g>
...
export const HeadphonesListeningIllustration = () => (
  <svg viewBox="0 0 500 400" className="section-svg-graphic" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g className="float-element-slow">
      ...
      <path d="M410 40 C405 35 400 38 400 43 C400 48 410 54 410 54 C410 54 420 48 420 43 C420 38 415 35 410 40 Z" fill="#FFA6DF" />
    </g>
...
export const ArchTestimonialGraphic = () => (
  <svg viewBox="0 0 700 220" className="section-svg-graphic" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <g transform="translate(145, 50)" className="float-element">
    ...
    <g transform="translate(480, 50)" className="float-element-slow">
